...
const mockBooks: Book[] = [
  {
    ...
    coverUrl: "/placeholder.svg?height=450&width=300&text=Война+и+мир",
    year: 1869,
  ...
  },
  {
    ...
    coverUrl: "/placeholder.svg?height=450&width=300&text=Преступление+и+наказание",
    year: 1866,
  ...
  },
  {
    ...
    coverUrl: "/placeholder.svg?height=450&width=300&text=Мастер+и+Маргарита",
    year: 1967,
    genre: "Фантастика",
    pages: 480,
    language: "Русский",
  },
  {
    ...
    coverUrl: "/placeholder.svg?height=450&width=300&text=1984",
    year: 1949,
    genre: "Антиутопия",
    pages: 328,
    language: "Английский",
