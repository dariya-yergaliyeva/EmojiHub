...
export default function ChatPage() {
  ...
  return (
    <>
      <Head>
        <title>Рекомендации - BookVerse</title>
        <meta name="description" content="Получите персонализированные рекомендации по чтению" />
      </Head>

      <div className="container flex flex-col h-[calc(100vh-4rem)] max-h-[calc(100vh-4rem)]">
